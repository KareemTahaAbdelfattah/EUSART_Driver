...
# 1 "MCAL_Layer/usart/../std_types.h" 1
# 13 "MCAL_Layer/usart/../std_types.h"
...
# 13 "MCAL_Layer/usart/../std_types.h" 2

# 1 "MCAL_Layer/usart/../compiler.h" 1
# 14 "MCAL_Layer/usart/../std_types.h" 2
...
# 1 "MCAL_Layer/usart/../hal_gpio.h" 1
# 15 "MCAL_Layer/usart/../hal_gpio.h"
# 1 "MCAL_Layer/usart/../GPIO/hal_gpio_cfg_inter.h" 1
# 15 "MCAL_Layer/usart/../hal_gpio.h" 2
# 41 "MCAL_Layer/usart/../hal_gpio.h"
typedef enum{
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t;
...
# 90 "MCAL_Layer/usart/../hal_gpio.h"
...
# 1 "MCAL_Layer/usart/../Interrupt/hal_internal_interrupt.h" 1
# 13 "MCAL_Layer/usart/../Interrupt/hal_internal_interrupt.h"
# 1 "MCAL_Layer/usart/../Interrupt/hal_interrupt_cfg.h" 1
# 19 "MCAL_Layer/usart/../Interrupt/hal_interrupt_cfg.h"
# 1 "MCAL_Layer/usart/../Interrupt/hal_interrupt_gen_cfg.h" 1
# 19 "MCAL_Layer/usart/../Interrupt/hal_interrupt_cfg.h" 2
# 60 "MCAL_Layer/usart/../Interrupt/hal_interrupt_cfg.h"
typedef enum{
    INTERRUPT_Low_Priority = 0,
    INTERRUPT_High_Priority,
}Interrupt_Priority_cfg;
# 13 "MCAL_Layer/usart/../Interrupt/hal_internal_interrupt.h" 2
...
# 11 "MCAL_Layer/usart/hal_usart.c" 2
...
STD_ReturnType EUSART_ASYNC_Init(const usart_t *_eusart){
    ...
    if(_eusart == ((void*)0)) ret = (STD_ReturnType)0x00;
    else{
...
static void EUSART_BUADRATE_Calculation(const usart_t *_eusart){
    ...
    switch(_eusart->buadrate_gen_cfg){
        case BUADRATE_ASYNC_8BIT_LOW_SPEED:
            ...
            TXSTAbits.BRGH = 0;
            BAUDCONbits.BRG16 = 0;
            baud_rate_Temp = ((8000000UL / (float)(_eusart->buadrate)) / 64) - 1;
            break;
        case BUADRATE_ASYNC_8BIT_HIGH_SPEED:
            TXSTAbits.SYNC = 0;
            TXSTAbits.BRGH = 1;
            BAUDCONbits.BRG16 = 0;
            baud_rate_Temp = ((8000000UL / (float)(_eusart->buadrate)) / 16) - 1;
            break;
        ...
        case BUADRATE_ASYNC_16BIT_HIGH_SPEED:
            ...
            TXSTAbits.BRGH = 1;
            BAUDCONbits.BRG16 = 1;
            baud_rate_Temp = ((8000000UL / (float)(_eusart->buadrate)) / 4) - 1;
            break;
...
static void eusart_async_tx_init(const usart_t *_eusart){
    if(_eusart->usart_tx_cfg.usart_tx_enable == 1){
        TXSTAbits.TXEN = 1;
        EUSART_TX_InterruptHandler = _eusart->EUSART_TX_DefaultInterruptHandler;

        if(_eusart->usart_tx_cfg.usart_tx_interrupt_enable == 1){
            PIE1bits.TXIE = 1;



            (PIE1bits.TXIE = 1);
# 190 "MCAL_Layer/usart/hal_usart.c"
            (INTCONbits.GIE = 1);
        ...
        if(_eusart->usart_tx_cfg.usart_tx_9bit_enable == 1){
            TXSTAbits.TX9 = 1;
        }else{
            TXSTAbits.TX9 = 0;
        }
...
static void eusart_async_rx_init(const usart_t *_eusart){
    ...
    if(_eusart->usart_rx_cfg.usart_rx_enable == 1){
        ...
        if(_eusart->usart_rx_cfg.usart_rx_interrupt_enable == 1){
            PIE1bits.RCIE = 1;


            (PIE1bits.RCIE = 1);
# 242 "MCAL_Layer/usart/hal_usart.c"
            (INTCONbits.GIE = 1);
        ...
        if(_eusart->usart_rx_cfg.usart_rx_9bit_enable == 1){
            RCSTAbits.RC9 = 1;
        }else{
            RCSTAbits.RC9 = 0;
        }
