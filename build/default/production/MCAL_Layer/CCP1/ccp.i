...
# 2 "<built-in>" 2
# 1 "MCAL_Layer/CCP1/ccp.c" 2
# 11 "MCAL_Layer/CCP1/ccp.c"
# 1 "MCAL_Layer/CCP1/ccp_hal.h" 1
# 13 "MCAL_Layer/CCP1/ccp_hal.h"
...
# 13 "MCAL_Layer/CCP1/ccp_hal.h" 2
...
# 16 "MCAL_Layer/CCP1/ccp_hal.h" 2

# 1 "MCAL_Layer/CCP1/ccp_hal_cfg.h" 1
# 17 "MCAL_Layer/CCP1/ccp_hal.h" 2
# 86 "MCAL_Layer/CCP1/ccp_hal.h"
typedef enum{
    CCP_PWM_MODE_ = 0,
    CCP_CAPTURE_MODE,
    CCP_COMPARE_MODE,
...
# 11 "MCAL_Layer/CCP1/ccp.c" 2
# 21 "MCAL_Layer/CCP1/ccp.c"
...
STD_ReturnType CCP_Init(const ccp_t *_ccp1_object){
    ...
    if(_ccp1_object == ((void*)0)) ret = (STD_ReturnType)0x00;
        ...
        if(_ccp1_object->ccp_inst == CCP1_INST) CCP1CONbits.CCP1M = (uint8)0x00;
        else CCP2CONbits.CCP2M = (uint8)0x00;
...
# 297 "MCAL_Layer/CCP1/ccp.c"
STD_ReturnType CCP_IsCompareCompelete(const ccp_t *_ccp1_object, uint8 *compare_status){
    STD_ReturnType ret = (STD_ReturnType)0x01;
    if(compare_status == ((void*)0) || _ccp1_object == ((void*)0)) ret = (STD_ReturnType)0x00;
    else{
        if(_ccp1_object->ccp_inst == CCP1_INST){
